...
class kubernetes::config (
  ...
  $kube_manifest_files = ['kube-apiserver.yaml', 'kube-controller-manager.yaml', 'kube-scheduler.yaml', 'clusterRoleBinding.yaml'] + ($etcd_version ? {'absent' => [], default => ['etcd.yaml']}) # lint:ignore:140chars
